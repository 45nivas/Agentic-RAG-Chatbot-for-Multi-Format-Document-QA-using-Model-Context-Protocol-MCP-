...
import { Dumbbell, ShieldAlert, ChevronDown, ChevronUp, CheckSquare, Square } from 'lucide-react';
...
export function WorkoutProgram({ trainingPlan }: WorkoutProgramProps) {
  ...
  return (
    <div className="clinical-card" style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '20px' }}>
